...
/*public class NumbersExample {
    ...
    static void print2(int n) {       //taking a number
        System.out.println ( n );     //printing the number
        print3 ( 3 );                //calling another function
    }
...
Since print5 does not call any other method, it returns, and its stack frame is removed.
